...
void bind_qwidget(py::module_ &m) {
  ...
  //                               })
  //        .def_property_readonly(
  //            "childrenRect", [](QWidget *self) { return self->childrenRect();
  //            })
  //        .def_property_readonly(
  //            "childrenRegion",
  ...
  //        //                          [](QWidget *self) { return
  //        self->focus(); }) .def_property_readonly("focusPolicy",
  //                               [](QWidget *self) { return
  //                               self->focusPolicy(); })
  //        .def_property_readonly("font",
  //                               [](QWidget *self) { return self->font(); })
  //        .def_property_readonly(
  ...
  //                               self->maximumSize(); })
  //        .def_property_readonly(
  //            "maximumWidth", [](QWidget *self) { return self->maximumWidth();
  //            })
  ...
  //        .def_property_readonly(
  //            "minimumWidth", [](QWidget *self) { return self->minimumWidth();
  //            })
  ...
  //                               })
  //        .def_property_readonly("pos", [](QWidget *self) { return
  //        self->pos(); }) .def_property_readonly("rect",
  //                               [](QWidget *self) { return self->rect(); })
  //        .def_property_readonly("size",
  //                               [](QWidget *self) { return self->size(); })
  ...
  //        Qt::WindowFlags());
  cls.def("acceptDrops", &QWidget::acceptDrops)
      ...
      //   .def("childAt", py::overload_cast<const QPoint &>(&QWidget::childAt))
      ...
      //   .def("grabMouse", py::overload_cast<QCursor *>(&QWidget::grabMouse))
